...
kubectl delete namespace vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-client1
for ((i = 1 ; i <= ${REPLICA_COUNT} ; i++)); do
  kubectl delete -f k8s-replica-node${i}-deployment.yml --namespace=vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-replica${i}
  kubectl delete -f ../config/k8s-replica-node${i}-pvc.yml --namespace=vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-replica${i}
  kubectl delete namespace vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-replica${i} 
