...
w3 = None
chainid = 5000
ethrpcApiUrl =  'http://ethrpc1.vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-client1.svc.cluster.local:8545'
w3 = Web3(Web3.HTTPProvider(ethrpcApiUrl, request_kwargs={"verify": False}))

#ethrpcApiUrl =  'https://ethrpc1.vmbc-a7dcc095-1b0d-4a72-9bec-9bffee69b857-client1.svc.cluster.local:8545'
